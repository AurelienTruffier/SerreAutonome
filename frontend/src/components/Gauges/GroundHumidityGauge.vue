        ...
        FetchData(){
            ...
            .then(data => {
                data.forEach(element => {
                    this.value = element["HumiditeSol"]
                });
            ...
            .then(data => {
                data.forEach(element => {
                    this.seuilBas = element['SeuilBasHumidSol'];
                    this.seuilHaut= element['SeuilHautHumidSol'];
                });
            })
            .catch(function(error) {
                console.log(error);
