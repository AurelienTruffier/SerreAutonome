        ...
        FetchData(){
            ...
            .then(data => {
                data.forEach(element => {
                    ...
                    const newValue = element['HumiditeSol'];
...
<style scoped>
#ground_humidity_chart{
    display: flex;
    justify-content: space-around;
    align-items: center;
}

#ground_humidity_chart #input_container{
    display: flex;
    width: 300px;
...
#ground_humidity_chart #input_container #select_max_values{
    width: 200px;
    padding: 6px;
    border-radius: 8px;
    border: none;
...
#ground_humidity_chart #input_container #update_btn{
    width: 220px;
...
#ground_humidity_chart #input_container #update_btn:hover{
    width: 250px;
}
